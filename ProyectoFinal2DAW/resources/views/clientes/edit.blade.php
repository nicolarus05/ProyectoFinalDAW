...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .form-control[readonly] { background:#f9fafb;cursor:default; }
...
<div class="main-wrapper">
    <header class="topbar">
        ...
        <span class="page-title">✏️ Editar Cliente</span>
        <div style="flex:1"></div>
        <a href="{{ route('clientes.show', $cliente->id) }}" style="font-size:12px;color:#a855f7;font-weight:600;text-decoration:none;margin-right:12px">← Ver detalle</a>
    ...
    <div class="content">
        <div class="panel">
            <div class="panel-header">
                <h2>✏️ Editar: {{ $cliente->user->nombre }} {{ $cliente->user->apellidos }}</h2>
                ...
                <form action="{{ route('clientes.update', $cliente->id) }}" method="POST">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="nombre" value="{{ old('nombre', $cliente->user->nombre) }}" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="form-label">👤 Apellidos</label>
                            <input type="text" name="apellidos" value="{{ old('apellidos', $cliente->user->apellidos) }}" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="telefono" value="{{ old('telefono', $cliente->user->telefono) }}" class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="form-label">🎂 Edad</label>
                            <input type="number" name="edad" value="{{ old('edad', $cliente->user->edad) }}" min="0" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="genero" value="{{ old('genero', $cliente->user->genero) }}" class="form-control" placeholder="Hombre / Mujer / Otro">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="email" name="email" value="{{ old('email', $cliente->user->email) }}" required class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="form-label">📅 Fecha de Registro</label>
                            <input type="text" name="fecha_registro" value="{{ $cliente->fecha_registro }}" readonly class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="notas_adicionales" rows="3" class="form-control">{{ old('notas_adicionales', $cliente->notas_adicionales) }}</textarea>
                    </div>
