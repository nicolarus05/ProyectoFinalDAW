...
<div class="main-wrapper">
    <header class="topbar">
        ...
        <span class="page-title">🛍️ Crear Producto</span>
                ...
                <form action="{{ route('productos.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="nombre" name="nombre" value="{{ old('nombre') }}"
                               required class="form-control" placeholder="Ej: Champú hidratante...">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="descripcion" name="descripcion" rows="3"
                                  class="form-control" placeholder="Descripción del producto...">{{ old('descripcion') }}</textarea>
                    </div>
