...
<div class="main-wrapper">
    ...
    <div class="content">
        <header class="topbar">
            <div class="topbar-title">🎫 Registrar Cobro</div>
    ...
    <div id="cobros-app" 
         ...
         class="bg-white rounded-xl shadow-sm p-6" style="max-width:760px">
        <div style="background:#1e1a4b;color:#fff;padding:14px 20px;border-radius:10px;margin-bottom:20px;font-size:15px;font-weight:700">🎫 Registrar Cobro</div>
