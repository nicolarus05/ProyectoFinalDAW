...
<div class="main-wrapper">
    <header class="topbar">
        ...
        <span class="page-title">➕ Nuevo Empleado</span>
        <div style="flex:1"></div>
        <a href="{{ route('empleados.index') }}" style="font-size:12px;color:#a855f7;font-weight:600;text-decoration:none;margin-right:12px">← Volver a empleados</a>
                ...
                <form action="{{ route('empleados.store') }}" method="POST">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="edad" value="{{ old('edad') }}" min="0" required
