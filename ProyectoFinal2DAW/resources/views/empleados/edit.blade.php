...
<div class="main-wrapper">
    <header class="topbar">
        ...
        <span class="page-title">✏️ Editar Empleado</span>
        <div style="flex:1"></div>
        <a href="{{ route('empleados.show', $empleado->id) }}" style="font-size:12px;color:#a855f7;font-weight:600;text-decoration:none;margin-right:12px">← Ver detalle</a>
    ...
    <div class="content">
        <div class="panel">
            <div class="panel-header">
                <h2>✏️ Editar Empleado: {{ $empleado->user->nombre }} {{ $empleado->user->apellidos }}</h2>
                <a href="{{ route('empleados.index') }}" style="font-size:11px;color:rgba(255,255,255,.7);text-decoration:none">← Volver a la lista</a>
            </div>
                ...
                <form action="{{ route('empleados.update', $empleado->id) }}" method="POST">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="nombre" value="{{ old('nombre', $empleado->user->nombre) }}" required
                                   class="form-control" placeholder="Nombre">
                        </div>
                        <div class="form-group">
                            <label class="form-label">👤 Apellidos</label>
                            <input type="text" name="apellidos" value="{{ old('apellidos', $empleado->user->apellidos) }}"
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="telefono" value="{{ old('telefono', $empleado->user->telefono) }}"
                                   class="form-control" placeholder="6XX XXX XXX">
                        </div>
                        <div class="form-group">
                            <label class="form-label">🎂 Edad</label>
                            <input type="number" name="edad" value="{{ old('edad', $empleado->user->edad) }}" min="0"
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="genero" value="{{ old('genero', $empleado->user->genero) }}"
                                   class="form-control" placeholder="Masculino / Femenino / Otro">
                        </div>
                        <div class="form-group">
                            <label class="form-label">✂️ Categoría <span style="color:#ef4444">*</span></label>
                            <select name="categoria" required class="form-control">
                                <option value="">Seleccione</option>
                                <option value="peluqueria" {{ old('categoria', $empleado->categoria)=='peluqueria'?'selected':'' }}>💇 Peluquería</option>
                                <option value="estetica"   {{ old('categoria', $empleado->categoria)=='estetica'  ?'selected':'' }}>💅 Estética</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="email" name="email" value="{{ old('email', $empleado->user->email) }}" required
                        ...
                        <div class="form-group">
                            ...
                            <p style="font-size:11px;color:#9ca3af;margin-top:4px">Deja vacío para mantener la contraseña actual.</p>
                        </div>
                    </div>
