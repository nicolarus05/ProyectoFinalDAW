        ...
        <form action="{{ route('deudas.pago.store', $cliente) }}" method="POST" class="space-y-4">
            ...
            <div>
                <label for="empleado_id" class="block text-sm font-medium text-gray-700 mb-1">
                    Empleado que realizó el servicio <span class="text-red-500">*</span>
                </label>
                ...
                @enderror
                <p class="text-sm text-gray-500 mt-1">
                    <i class="fas fa-info-circle"></i> Se ha pre-seleccionado el empleado que realizó los servicios originales
                </p>
            </div>
