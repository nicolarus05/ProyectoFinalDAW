...
<div class="main-wrapper">
    <header class="topbar">
        ...
        <span class="page-title">➕ Nuevo Servicio</span>
        <div style="flex:1"></div>
        <a href="{{ route('servicios.index') }}" style="font-size:12px;color:#a855f7;font-weight:600;text-decoration:none;margin-right:12px">← Volver a servicios</a>
                ...
                <form action="{{ route('servicios.store') }}" method="POST">
                    ...
                    <div class="form-row">
                        <div class="form-group" style="grid-column:1/-1">
                            ...
                            <input type="text" name="nombre" value="{{ old('nombre') }}" required class="form-control" placeholder="Nombre del servicio">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" name="tiempo_estimado" value="{{ old('tiempo_estimado') }}" required min="1" class="form-control" placeholder="ej. 30">
                        </div>
                        <div class="form-group">
                            <label class="form-label">💶 Precio (€) <span style="color:#ef4444">*</span></label>
                            <input type="number" step="0.01" name="precio" value="{{ old('precio') }}" required min="0" class="form-control" placeholder="ej. 25.00">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select name="categoria" id="select-categoria" required class="form-control" onchange="filtrarSubcategorias()">
                                <option value="peluqueria" {{ old('categoria','peluqueria') == 'peluqueria' ? 'selected' : '' }}>✂️ Peluquería</option>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="descripcion" rows="3" class="form-control" placeholder="Descripción opcional del servicio">{{ old('descripcion') }}</textarea>
                    </div>
